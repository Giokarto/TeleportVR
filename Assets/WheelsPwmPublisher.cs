...
public class WheelsPwmPublisher : MonoBehaviour
{
    ROSConnection ros;
    ...
    {
        var linear = InputManager.Instance.GetControllerJoystick(true).y;
        var angular = -InputManager.Instance.GetControllerJoystick(false).x;
