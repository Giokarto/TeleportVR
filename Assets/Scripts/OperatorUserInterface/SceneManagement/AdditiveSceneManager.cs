...
namespace OperatorUI
{
    ...
    public class AdditiveSceneManager : MonoBehaviour
    {
        ...
        public void ChangeScene(Scenes newScene, BeforeSceneUnloadDelegate beforeSceneUnload,
            OnSceneUnloadDelegate onSceneUnload, BeforeSceneLoadDelegate beforeSceneLoad,
            OnSceneLoadDelegate onSceneLoad)
        {
        ...
        IEnumerator UnloadScene(Scenes newScene, BeforeSceneUnloadDelegate beforeSceneUnload,
            OnSceneUnloadDelegate onSceneUnload, BeforeSceneLoadDelegate beforeSceneLoad,
            OnSceneLoadDelegate onSceneLoad)
        {
            if (currentScene == Scenes.NONE)
