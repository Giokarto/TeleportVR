...
namespace Widgets
{
    ...
    public class WidgetInteraction : Singleton<WidgetInteraction>
    {
        ...
        void Update()
        {
            MarkAnimusConnected(serverData.ConnectedToServer);
            MarkModalityConnected(Modality.AUDITION, serverData.ModalityConnected[Modality.AUDITION]);
            MarkModalityConnected(Modality.VOICE, serverData.ModalityConnected[Modality.VOICE]);
            MarkModalityConnected(Modality.MOTOR, serverData.ModalityConnected[Modality.MOTOR]);
        }
        ...
        private static Dictionary<Modality, int> modalityMap = new Dictionary<Modality, int>()
        {
            { Modality.VOICE, 25 },
            { Modality.AUDITION, 26},
            { Modality.MOTOR, 21},
            //{ Modality.VISION , 28},
           // { Modality.EMOTION , 29}
        };
        ...
        public static void MarkModalityConnected(Modality modality, bool connected)
        {
