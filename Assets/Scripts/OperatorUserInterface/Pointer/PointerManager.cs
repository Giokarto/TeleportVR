...
namespace OperatorUserInterface
{
    ...
    /// </summary>
    [Obsolete("CurvedUI from version 3.0 can handle input with Unity XR Interaction Toolkit, " +
              "and laser pointer is shown with XRInteractorLineVisual.")]
    public class PointerManager : Singleton<PointerManager>
    {
        [Header("Select Interaction Techniques")]
        [Tooltip(
            "Technique for pointing. Auto switches between PointerController and PointerMouse depending on the Plattform.")]
