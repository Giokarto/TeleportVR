...
public class InputManager : Singleton<InputManager>
{
    ...
    public bool GetLeftControllerAvailable()
    {
        ...
        {
            UnityEngine.XR.InputDevices.GetDevicesWithCharacteristics(InputDeviceCharacteristics.Left, controllerLeft);
        }
    ...
    public bool GetRightControllerAvailable()
    {
        ...
        {
            UnityEngine.XR.InputDevices.GetDevicesWithCharacteristics(InputDeviceCharacteristics.Right, controllerRight);
        }
